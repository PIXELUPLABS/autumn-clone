	...
	return (
		...
		>
			<div className="col-start-1 row-start-1 flex flex-col z-10 w-full relative">
				<div className="relative w-full flex flex-col justify-between min-h-[200px] md:min-h-[400px]">
					...
					<div className="flex flex-col lg:flex-row justify-between pt-[32px] md:pt-24 pb-8 md:pb-16 pl-4.5 xl:pl-[90px] pr-4 sm:pr-8 lg:pr-12 gap-10 md:gap-16 lg:gap-8 relative z-10">
